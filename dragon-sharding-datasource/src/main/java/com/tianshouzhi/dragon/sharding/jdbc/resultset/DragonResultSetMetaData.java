...
public class DragonResultSetMetaData extends WrapperAdapter implements ResultSetMetaData{
    ...
    public DragonResultSetMetaData(List<ColumnMetaData> columnMetaDataList) {
    ...
    public boolean isAutoIncrement(int column) throws SQLException {
        return columnMetaDataList.get(column).isAutoIncrement();
    }

    @Override
    public boolean isCaseSensitive(int column) throws SQLException {
        return columnMetaDataList.get(column).isCaseSensitive();
    }

    @Override
    public boolean isSearchable(int column) throws SQLException {
        return columnMetaDataList.get(column).isSearchable();
    }

    @Override
    public boolean isCurrency(int column) throws SQLException {
        return columnMetaDataList.get(column).isCurrency();
    }

    @Override
    public int isNullable(int column) throws SQLException {
        return columnMetaDataList.get(column).isNullable();
    }

    @Override
    public boolean isSigned(int column) throws SQLException {
        return columnMetaDataList.get(column).isSigned();
    }
    ...
    public boolean isReadOnly(int column) throws SQLException {
        return columnMetaDataList.get(column).isReadOnly();
    }

    @Override
    public boolean isWritable(int column) throws SQLException {
        return columnMetaDataList.get(column).isWritable();
    }

    @Override
    public boolean isDefinitelyWritable(int column) throws SQLException {
        return columnMetaDataList.get(column).isDefinitelyWritable();
    }
