...
public class DragonShardingPrepareStatement extends DragonShardingStatement implements DragonPrepareStatement{
    ...
    public DragonShardingPrepareStatement(String sql, int resultSetType, int resultSetConcurrency, DragonShardingConnection dragonShardingConnection) {
        super(resultSetType, resultSetConcurrency, dragonShardingConnection);
        this.prepareCreateType= SQL_RESULTSET_TYPE_CONCURRENCY;
        this.sql=sql;
    }

    public DragonShardingPrepareStatement(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability, DragonShardingConnection dragonShardingConnection) {
    ...
    public DragonShardingPrepareStatement(String sql, int autoGeneratedKeys, DragonShardingConnection dragonShardingConnection) {
        super(dragonShardingConnection);
        this.sql=sql;
    ...
    public DragonShardingPrepareStatement(String sql, int[] columnIndexes, DragonShardingConnection dragonShardingConnection) {
        super(dragonShardingConnection);
        this.sql=sql;
    ...
    public DragonShardingPrepareStatement(String sql, String[] columnNames, DragonShardingConnection dragonShardingConnection) {
        super(dragonShardingConnection);
        this.sql=sql;
