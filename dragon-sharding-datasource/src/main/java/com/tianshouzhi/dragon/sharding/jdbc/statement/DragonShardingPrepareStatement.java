...
public class DragonShardingPrepareStatement extends DragonShardingStatement implements DragonPrepareStatement{
    ...
    public DragonShardingPrepareStatement(DragonShardingConnection dragonShardingConnection) {
        super(dragonShardingConnection);
    }

    public DragonShardingPrepareStatement(int resultSetType, int resultSetConcurrency, DragonShardingConnection dragonShardingConnection) {
        super(resultSetType, resultSetConcurrency, dragonShardingConnection);
    }

    public DragonShardingPrepareStatement(int resultSetType, int resultSetConcurrency, int resultSetHoldability, DragonShardingConnection dragonShardingConnection) {
