...
public class DragonHAStatement extends WrapperAdapter implements Statement {
   ...
   //===================显示指定进行更新 =======================
        ...
        for (int i = 0; i < maxRetryTimes; i++) {
            try {
                if(executeType!=EXECUTE_BATCH){
                    createRealStatement(dragonHAConnection.getRealConnection(sql));
                }else{
                    dragonHAConnection.changeToWtiteConnectionIfNeed();
                }
                switch (executeType) {
                    case EXECUTE_QUERY:
                ...
                this.generatedKeys = this.getGeneratedKeys();
                return isResultSet;
                ...
                if (exceptionSorter.isExceptionFatal(e)) {//如果是致命异常
                    ...
                    if (dragonHAConnection.getCurrentRealConnection().getAutoCommit() == true
    ...
    public int executeUpdate() throws SQLException {
        this.executeType=EXECUTE_UPDATE;
        doExecute();
        return this.updateCount;
    }

    public ResultSet executeQuery() throws SQLException {
        this.executeType=EXECUTE_QUERY;
        doExecute();
