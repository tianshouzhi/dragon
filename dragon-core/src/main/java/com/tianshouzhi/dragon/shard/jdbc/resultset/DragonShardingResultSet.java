package com.tianshouzhi.dragon.shard.jdbc.resultset;
...
public class DragonShardingResultSet implements ResultSet {
	...
	public DragonShardingResultSet(DragonShardingStatement dragonShardingStatement, DragonResultSetMetaData metaData,
	      List<ResultSet> realResultSetList, List<RowRecord> rowRecords) {
	...
	/*
	 * public void setRowRecords( List<RowRecord> rowRecords) { this.rowRecords = rowRecords; }
	 */

	@Override
	public String toString() {
		return "DragonShardingResultSet{" + "rowRecords=" + rowRecords + '}';
	}
	...
	/**
	 * 代表一行记录 Created by TIANSHOUZHI336 on 2017/3/10.
	 */
	public class RowRecord {
		...
		@Override
		public String toString() {
			return "RowRecord{" + "resultsMap=" + resultsMap + '}';
		}
	}
}
