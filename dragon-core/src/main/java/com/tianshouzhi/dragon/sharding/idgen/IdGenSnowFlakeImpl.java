package com.tianshouzhi.dragon.sharding.idgen;

/**
 * //TODO 与dragon console整合，本来就可以拉取配置，此时多增加一个功能，通过dragon_console，根据appName获取id Created by TIANSHOUZHI336 on 2017/3/9.
 */
public class IdGenSnowFlakeImpl implements IdGenerator{
	...
	public synchronized Long getAutoIncrementId() throws Exception {
		...
		return ((currentTimestamp - DEFAULT_TWEPOCH) << (WORKER_ID_BITS + SEQUENCE_BITS)) | (workerId << WORKER_ID_BITS)
		      | seqenceId;
	}
