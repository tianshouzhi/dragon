 ...
 */
public class DragonCallableStatement extends DragonPrepareStatement implements CallableStatement{

    public DragonCallableStatement(CallableStatement delegate, DragonConnection connection) {
