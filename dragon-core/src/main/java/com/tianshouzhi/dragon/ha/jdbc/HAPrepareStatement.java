 ...
 */
public class HAPrepareStatement extends HAStatement implements DragonPrepareStatement {

	private static final Log LOG= LoggerFactory.getLogger(HAPrepareStatement.class);
	...
	public HAPrepareStatement(String sql, HAConnection dragonHAConnection) throws SQLException {
		super(dragonHAConnection);
		this.prepareCreateType = SQL;
		this.sql = sql;
	}

	public HAPrepareStatement(String sql, int resultSetType, int resultSetConcurrency,
							  HAConnection dragonHAConnection) throws SQLException {
		super(resultSetType, resultSetConcurrency, dragonHAConnection);
		this.prepareCreateType = SQL_RESULTSET_TYPE_CONCURRENCY;
		this.sql = sql;
	}

	public HAPrepareStatement(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability,
							  HAConnection dragonHAConnection) throws SQLException {
	...
	public HAPrepareStatement(String sql, int autoGeneratedKeys, HAConnection dragonHAConnection)
	      throws SQLException {
		super(dragonHAConnection);
		this.sql = sql;
	...
	public HAPrepareStatement(String sql, int[] columnIndexes, HAConnection dragonHAConnection)
	      throws SQLException {
		super(dragonHAConnection);
		this.sql = sql;
	...
	public HAPrepareStatement(String sql, String[] columnNames, HAConnection dragonHAConnection)
	      throws SQLException {
		super(dragonHAConnection);
		this.sql = sql;
