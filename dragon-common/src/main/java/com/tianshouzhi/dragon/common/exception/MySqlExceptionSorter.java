    ...
    public boolean isExceptionFatal(final SQLException e) {
        ...
        while(cause!=null&&i<MAX_LOOP_TIMES){
            ...
            switch (errorCode) {
                ...
                case 1041: // ER_OUT_OF_RESOURCES 系统内存不足,check if mysqld or some other process uses all available memory; if not, you may have to use 'ulimit' to allow mysqld to use more memory or you can add more swap space
