...
public interface DragonPrepareStatement extends PreparedStatement {
	enum PrepareCreateType {
		SQL, SQL_AUTOGENERATEDKEYS, SQL_COLUMNINDEXES, SQL_COLUMNNAMES, SQL_RESULTSET_TYPE_CONCURRENCY, SQL_RESULTSET_TYPE_CONCURRENCY_HOLDABILITY
	}
	...
	enum ParamType {
		setNull, setBoolean, setByte, setShort, setInt, setLong, setFloat, setDouble, setBigDecimal, setString, setBytes, setDate, setTime, setTimestamp, setAsciiStream2, setUnicodeStream2, setBinaryStream2, setObject2, setObject, setCharacterStream2, setRef, setBlob, setClob, setArray, setDate2, setTime2, setTimestamp2, setNull2, setURL, setRowId, setNString, setNCharacterStream, setCharacterStream, setBinaryStream, setAsciiStream, setObject3, setSQLXML, setNClob2, setBlob2, setClob2, setNCharacterStream2, setNClob;

		public static void setPrepareStatementParams(PreparedStatement ps, int parameterIndex, Object[] values,
		      DragonPrepareStatement.ParamType paramType) throws SQLException {
			switch (paramType) {
			case setNull:
